...
We developed a shiny App to provide a local and cloud WEB interface (development status) to annotate and visulize NGS data. Now, we have integrated the [maftools](https://github.com/PoisonAlien/maftools) and [gvmap](https://github.com/ytdai/gvmap) to draw the mutation and heatmap. Now, serveral useful WEB functions, such as upload, plot and export PDF/SVG, have been provided.
