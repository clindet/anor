...
check_shiny_dep <- function(install = FALSE) {
  ...
  cran_pkgs <- c("shinycssloaders", "Cairo", "shinydashboard", "configr", "data.table", 
    "shinyjs", "DT", "stringr", "liteq", "ggplot2", "benchmarkme", "rmarkdown", 
    "markdown")
...
#' set_shiny_workers(4)
#'}
set_shiny_workers <- function(n, shiny_config_file = Sys.getenv("ANNOVARR_SHINY_CONFIG", 
