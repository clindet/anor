...
#' @param return_col_names.profix Setting the returned colnum names profix
...
annotation.cols.match <- function(dat = data.table(), anno.name = "", buildver = "hg19", 
  ...
  return_col_names = "", return_col_names.profix = "", format_dat_fun = format.cols, 
  ...
  return(do.call(after.query.steps, list(dat = dat, selected.db.tb = selected.db.tb, 
    ...
    db_col_order = db_col_order, return_col_names = return_col_names, return_col_names.profix = return_col_names.profix, 
...
annotation.region.match <- function(dat = data.table(), anno.name = "", buildver = "hg19", 
  ...
  return_col_index = 4, return_col_names = "", return_col_names.profix = "", format_dat_fun = format.cols, 
  dbname_fixed = NULL, table_name_fixed = NULL, setdb_fun = set.db, set_table_fun = set.table, 
  ...
  return(do.call(after.query.steps, list(dat = dat, selected.db.tb = selected.db.tb, 
    ...
    return_col_names = return_col_names, return_col_names.profix = return_col_names.profix, 
    tb.colnames = tb.colnames, tb.colnames.raw = tb.colnames.raw, database.con = database.con, 
