...
after.query.steps <- function(dat = NULL, selected.db.tb = NULL, format_db_tb_fun = NULL, 
  ...
  dbname = NULL, return_col_index = NULL, return_col_names = NULL, return_col_names.profix = NULL, 
  ...
  if (!is.null(return_col_names.profix) && return_col_names.profix != "") {
    colnames(result) <- paste0(return_col_names.profix, colnames(result))
  }
...
return.empty.col <- function(dat.list = NULL, tb.colnames = "", return_col_index = "", 
  return_col_names = "", return_col_names.profix = "") {
  result <- NULL
