...
annovar <- function(perl = Sys.which("perl"), cmd.pool = list(script1.downdb = "{{perl}} {{script}}{{extra.params}} -downdb {{buildver}} {{webfrom}} {{down.dbname}} {{database.dir}}", 
  script1.gene.based = "{{perl}} {{script}}{{extra.params}} {{buildver}} {{input.file}} {{database.dir}}", 
  script1.region.based = "{{perl}} {{script}} -regionanno{{extra.params}} {{buildver}} {{dbtype}} {{input.file}} {{database.dir}}", 
  script1.filter.based = "{{perl}} {{script}} -filter{{extra.params}} {{buildver}} {{dbtype}} {{input.file}} {{database.dir}}", 
  script2 = "{{perl}} {{script}} {{input.file}} {{database.dir}} {{buildver}} -remove -protocol {{dbtype}} -operation {{operation}} -nastring . -otherinfo -vcfinput"), 
