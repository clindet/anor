...
## Opencpu package for REST API

[Opencpu](https://www.opencpu.org/) is a tool for R users to build the web service REST API. It is a good choice for those command line users to finish specific R tasks without the Rstudio GUI or web graphic interface.

A simple API document can be found in [here](https://www.opencpu.org/api.html). annovarR will use the related API to provide the REST API.

<img src="../man/figures/opencpu.jpg" align="center" />
